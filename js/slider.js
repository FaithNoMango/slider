...
{  
  ...
  {
	$("#slider").css({"width": properties.width, "height": properties.height});
	$("#slider_img").css({"width": properties.width, "height": properties.height - 40});
	$("#slider_img img").css({"width": properties.width, "height": properties.height - 40});    

	var speed = properties.fade_speed;
    var imgs = $("#slider_img").children();
    ...
    $("#slider_bips").append(bippies);
    var bips = $("#slider_bips").children();
    ...
    $("#slider_left a").mouseenter(function()
    {
    ...
    $("#slider_right a").mouseenter(function()
    {
    ...
    $("#slider_left a").on("click", function()
    {
	  $(imgs).animate({opacity: 0}, {duration: speed});
	  if(current > 0)
	  {
    ...
    $("#slider_right a").on("click", function()
    {
	  $(imgs).animate({opacity: 0}, {duration: speed});
	  if(current < total-1)
	  {
